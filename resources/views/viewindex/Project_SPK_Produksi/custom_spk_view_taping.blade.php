...
@if($p->spk->status =='2') 
<td>
<a href="{{ url('admin/update_status_to_proses/'.$p->spk->id) }}" class="btn btn-warning btn-sm"  title="Proses">Proses</a>
</td>
@elseif($p->spk->status =='3') 
<td>
<a href="{{ url('admin/proses_update/'.$p->spk->id) }}" class="btn btn-success btn-sm"  title="Selesai">Selesai</a>
</td>
@else
<td>
Selesai
