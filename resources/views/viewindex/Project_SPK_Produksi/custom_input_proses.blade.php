...
<td><select name="nama_operator" class="form-control3" id="nama_operator">  
...
<td style="width:40px">
<button type="submit" class="btn btn-sm" form="proses_produksi" title="Add" id="detail_submit" >
<i class="fa fa-plus" style="color:green;" title="Add"></i>
</button>
</td>
...
<br>
<center><a href="{{ url('admin/button_back_rincian/')  }}" class="btn btn-warning"  title="Back">
